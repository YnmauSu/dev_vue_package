            ...
            <el-table
                ...
                <el-table-column :label="itme" v-for="(itme, inx) in tableKey" :key="inx">
                    <template slot-scope="scope">
                        <div>
                            <input type="text" class="el-input__inner" v-bindingProp='itemProps[inx]' v-model="tableData[scope.$index][inx]" v-if="!types[inx] || /^(input|\s)/.exec(types[inx])" @blur="types[inx].indexOf('@blur') > -1 ? handleBackData() : function(){}" @input="types[inx].indexOf('@change') > -1 ? handleBackData() : function(){}">
                            <!--<el-input ></el-input>-->
                            ...
                            <el-select v-model="tableData[scope.$index][inx]" v-if="types[inx] === 'select'" filterable>
                                <el-option
                            ...
                            <el-select v-model="tableData[scope.$index][inx]" v-if="types[inx] === 'selects'"  multiple collapse-tags filterable>
                                <el-option
